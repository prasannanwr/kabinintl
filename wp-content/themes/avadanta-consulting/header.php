					...
					<div class="logo">
						  <?php
							if( function_exists( 'has_custom_logo' ) && has_custom_logo() ){
								$icon_dir = esc_url( home_url( '/wp-content/themes/avadanta/assets/images/' ) );
								//apply_filters( 'icon_dir', ABSPATH . WPINC . '/images/media' );
								$logo_img_src = $icon_dir."logo-white-notext.png";
								//the_custom_logo();
							?>
							<img class="custom-logo" alt="NPA" src="<?=$logo_img_src;?>" width="90" />
							<span>NP Associates Pvt Ltd</span>
							<?php
							}
