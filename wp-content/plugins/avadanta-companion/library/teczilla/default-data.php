...
function avata_avadanta_get_slider_default() {
	...
	return apply_filters(
		'avadanta_slider_content', json_encode(
			array(
				array(
				'title'      => esc_html__( 'Welcome', 'teczilla' ),
				'text'       => esc_html__('We Provide Great Value For Business
', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider1.jpg'),
				),
				array(
				'title'      => esc_html__( 'We values You', 'teczilla' ),
				'text'       => esc_html__('We Provide Great Value For Business', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider2.jpg'),
				),
