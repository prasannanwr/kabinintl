...
function avata_avadanta_get_slider_default() {
	...
	return apply_filters(
		'avadanta_slider_content', json_encode(
			array(
				array(
				'title'      => esc_html__( 'Online Strategy & Consulting Services Available', 'teczilla' ),
				'text'       => esc_html__('Teczilla is a multi-purpose WordPress theme for big and small-sized businesses working in creative and original industries.
', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider3.jpg'),
				),
				array(
				'title'      => esc_html__( 'We values You', 'teczilla' ),
				'text'       => esc_html__('Teczilla is a multi-purpose WordPress theme for big and small-sized businesses working in creative and original industries.', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider4.jpg'),
				),
