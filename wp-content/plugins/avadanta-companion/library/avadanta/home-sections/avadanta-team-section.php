...
if ( ! function_exists( 'avata_avadanta_team' ) ) :
	...
	function avata_avadanta_team() {
		...
		// string(1023) "[{"icon_value":"","image_url":"http://localhost/npa/wp-content/uploads/2021/09/Ashistha-Joshi.jpg","title":"Ashista Joshi","subtitle":"Accountant","social_repeater":"","id":"social-repeater-611e6852fd80a","shortcode":"undefined","open_new_tab":"no"},{"icon_value":"Influencer","image_url":"http://localhost/npa/wp-content/uploads/2021/09/Ashok-Tuladhar.jpg","title":"Ashok Tuladhar","subtitle":"","social_repeater":"[]","id":"social-repeater-611e68521ee5d","shortcode":"undefined","open_new_tab":"no"},{"icon_value":"","image_url":"http://localhost/npa/wp-content/uploads/2021/09/Mandira-Maharjan.jpg","title":"Mandira Maharjan","subtitle":"Programmer","social_repeater":"","id":"social-repeater-611e685237d6d","shortcode":"undefined","open_new_tab":"no"},{"icon_value":"","image_url":"http://localhost/npa/wp-content/uploads/2021/09/Missu-Bhandari-255x300.jpg","title":"Missu Bhandari","subtitle":"Document Controller","social_repeater":"","id":"social-repeater-611e685250478","shortcode":"undefined","open_new_tab":"no"}]" 
		...
		if($home_team_section_enabled !='off')
     {
		...
		<div class="section section-x team bg-secondary">
			<div class="container">
				...
				<!-- added new team members rows -->
				<!-- .row -->
				<div class="row justify-content-center gutter-vr-30px">
					<?php 
					$teams_array = array();
					array_push($teams_array, array('image_url' => "http://localhost/npa/wp-content/uploads/2021/09/Narendra-Prajapati.jpg", 'title' => "Narendra Prajapati", 'subtitle' => ""));
					array_push($teams_array, array('image_url' => "http://localhost/npa/wp-content/uploads/2021/09/Rajeev-Sharma.jpg", 'title' => "Rajeev Sharma", 'subtitle' => ""));
					array_push($teams_array, array('image_url' => "http://localhost/npa/wp-content/uploads/2021/09/Suresh-Purkuti.jpg", 'title' => "Suresh Purkuti", 'subtitle' => ""));
					array_push($teams_array, array('image_url' => "http://localhost/npa/wp-content/uploads/2021/09/Sushil-Aryal.jpg", 'title' => "Sushil Aryal", 'subtitle' => ""));
					$team_options1 = json_encode($teams_array);

					$team_options1 = json_decode($team_options1);
					//var_dump($team_options1);exit;
					if( $team_options1!='' )
					{
					foreach($team_options1 as $team_item){
